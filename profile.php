		...
		*/		
        ...
        <div class='p-3 bg-dark rounded-3 mt-3'>
          <div class='d-flex flex-row align-items-center gap-3'>
            ...
            />
            <div class='flex-fill'>
              <div class='fs-6 lh-1'>".$array_users_username[$row_1['posted_by']]."</div>
          ...
          <div class='mt-3'>
			...
			if ($row_1['post_image'] !== null && $row_1['post_image'] !== '') {
				
				//$file_ext = strtolower(end(explode(".",$row_1['post_image'])));
				$file_ext2 = explode(".",$row_1['post_image']);
				$file_ext = strtolower(end($file_ext2));
				//echo $file_ext2;
				
				if($file_ext=="jpg" || $file_ext=="jpeg" || $file_ext=="png" || $file_ext=="bmp") {
					echo "
					<span><a href='post_files/".$row_1['post_image']."' target='_blank' id='a_".$row_1['id']."'></span>
					<img onclick=\"document.getElementById('a_".$row_1['id']."').click();\"
				...
				elseif($file_ext=="pdf") {
					...
					<span><a href='post_files/".$row_1['post_image']."' target='_blank' id='a_".$row_1['id']."'></span>
					<img onclick=\"document.getElementById('a_".$row_1['id']."').click();\"
					  src='assets/img/pdf_viewer.png/".$row_1['post_image']."'
					  alt=''
					  class='w-100 object-fit-cover'
					  style='max-height: 250px'
					/>
					...
					<span><a href='post_files/".$row_1['post_image']."' target='_blank' id='a_".$row_1['id']."'></span>
					<img onclick=\"document.getElementById('a_".$row_1['id']."').click();\"
					  src='assets/img/file_viewer.png/".$row_1['post_image']."'
					  alt=''
					  class='w-100 object-fit-cover'
					  style='max-height: 250px'
					/>
