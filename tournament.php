    ...
    <div class="position-relative container">
      <div class="w-100 pt-4">
			...
			if($x==1) { $active="active"; } else { $active=""; } 
				...
				echo "
					<div class='carousel-item $active'>
					  <img
						src='tournament_banner/".$row_0['banner']."'
        ...
        <section id="tournament-by-games__section" class="mt-5">
		  ...
		  <?php
			$results_1 = DB::query("select distinct(game_name_id) from tournament order by id desc limit 0,3");
			foreach ($results_1 as $row_1) {
				echo "
				<div class='col-4'>
				  <img
