        ...
        <section id="quick-match__section" class="mt-5">
		  ...
		  <?php
			...
			foreach ($results_2 as $row_2) {
				...
				$num_of_participant = DB::queryFirstField("SELECT count(*) FROM tournament_teams where tournament_code=%s", $row_2['tournament_code']);
				
			echo "
				<div class='d-flex flex-col gap-2 mt-3' style='cursor:pointer;' onclick=\"window.location.href='tournament-detail.php?tid=".$row_2['id']."';\">
