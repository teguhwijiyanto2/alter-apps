    ...
    <section>
      <div class="">
        ...
        <div class="tab__more-category overflow-x-scroll" style="white-space: nowrap; ">
          <div data-tab="1_mobile_prepaid" class="d-inline-block px-3 up__tab-item active">Mobile Prepaid</div>
          <div data-tab="2_mobile_data" class="d-inline-block px-3 up__tab-item">Mobile Data</div>
          <div data-tab="3_top_up_game" class="d-inline-block px-3 up__tab-item">Top Up Game</div>
          <div data-tab="4_ewallet" class="d-inline-block px-3 up__tab-item">eWallet</div>
          <div data-tab="5_voucher" class="d-inline-block px-3 up__tab-item">Voucher</div>       
        </div>
        <!-- Tab End -->
...
";			
			...
			echo "			
						  <a
							href='#' onclick=\"document.getElementById('formPurchase_".$row_A2['id']."').submit();\"
