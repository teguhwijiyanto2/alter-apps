...
$results_1 = DB::query("UPDATE matchmaking_availability set request_status='Accepted' where id=%i", $_GET["pid"]);
...
try {
	...
	$subject = "[ALTER] Request to play ACCCEPTED"; 
	 
	$htmlContent = " 
    <html> 
    <head> 
        <title>Request to play ACCCEPTED</title> 
    </head> 
    <body> 
        <h1>Request to play has been ACCCEPTED</h1> 
    ...
    $mail->Subject = '[ALTER] Request to play ACCCEPTED';
    ...
    $mail2->Subject = '[ALTER] Request to play ACCCEPTED';
