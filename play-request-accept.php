...
$results_1 = DB::query("UPDATE matchmaking_availability set request_status='Accepted', is_read=1, approval_time=now() where id=%i", $_GET["pid"]);
...
try {
	...
	$subject = "[ALTER] Your request to play has been ACCCEPTED by ".$array_users_name[$results_2['approver_id']].""; 
	 
	$htmlContent = " 
    <html> 
    <head> 
        <title>Your request to play has been ACCCEPTED by ".$array_users_name[$results_2['approver_id']]."</title> 
    </head> 
    <body> 
        <h1>Your request to play has been ACCCEPTED by ".$array_users_name[$results_2['approver_id']]."</h1> 
    ...
    $mail->Subject = "[ALTER] Your request to play has been ACCCEPTED by ".$array_users_name[$results_2['approver_id']]."";
	...
	$to2 = "".$array_users_email[$results_2['approver_id']].""; 
	$from = "teguh@alterspace.gg"; 
	$fromName = 'A.L.T.E.R'; 
	 
	$subject = "[ALTER] You have ACCCEPTED a Play Request from ".$array_users_name[$results_2['requestor_id']].""; 
	 
	$htmlContent2 = " 
    <html> 
    <head> 
        <title>You have ACCCEPTED a Play Request from ".$array_users_name[$results_2['requestor_id']]."</title> 
    </head> 
    <body> 
        <h1>You have ACCCEPTED a Play Request from ".$array_users_name[$results_2['requestor_id']]."</h1> 
        <table cellspacing='0' style='border: 2px dashed #FB4314; width: 100%;'> 
            <tr> 
                <th>Players:</th><td>".$array_users_name[$results_2['requestor_id']]." x ".$array_users_name[$results_2['approver_id']]."</td> 
            </tr>
    ...
    $mail2->Subject = "[ALTER] You have ACCCEPTED a Play Request from ".$array_users_name[$results_2['requestor_id']]."";
