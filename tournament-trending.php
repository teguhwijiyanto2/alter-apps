      ...
      <div class="container px-4">
        ...
        <div class="d-flex flex-column gap-2 mt-3">
		  ...
		  foreach ($results_1 as $row_1) {
			 ...
			 $num_of_participant = DB::queryFirstField("SELECT count(*) FROM tournament_teams where tournament_code=%s AND payment_status='Paid'", $row_1['tournament_code']);			  
              ...
              <div class='p-3 d-flex flex-column gap-2'>
                ...
                <div class='d-flex flex-row align-items-center gap-2'>
                  <img
                    ...
                    width='24'
                  />
                  <span class='fw-light'>".$num_of_participant."/".$row_1['participant_number']." Team</span>
                </div>
                <div class='d-flex flex-row align-items-center gap-2'>
                  <img
