...
<?php
    ...
    <section id="post" class="tab__content d-block">
      <div class="container">
        <!-- Post Status Start -->
		<form action="post-submit.php" method="POST" id="formPost">
        ...
        >
          ...
          <input type="file" class="d-none" id="image"  name="file_1" />
        </div>
		</form>
        <!-- Post Status End -->
    ...
    <section id="review" class="tab__content d-none">
      ...
      <div class="container mt-4">
        <h5>Sort by</h5>
        <div class="d-inline">
          <button class="btn btn-primary fs-small px-4 py-0 rounded-pill">
            Latest
          </button>
          <button class="btn btn-dark fs-small px-4 py-0 rounded-pill">
            Highest
          </button>
          <button class="btn btn-dark fs-small px-4 py-0 rounded-pill">
            Lowest
        ...
        <div class="p-3 bg-dark rounded-3 mt-3">
          <div class="d-flex flex-row align-items-center gap-3">
            ...
            />
            <div class="flex-fill">
              <div class="fs-6 lh-1">Alter Member 2</div>
              <span class="text-secondary" style="font-size: 10pt"
          ...
          <div class="mt-3">
            ...
            <p class="text-secondary">
              ...
              maxime consequatur consequuntur sint at commodi.
            </p>
          </div>
        </div>		
		-->
