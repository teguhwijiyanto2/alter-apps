...
<html lang="en">
  ...
  <body>
    ...
    <div
      ...
      style="background-image: url('tournament_banner/18sN2DiLlcd.banner.jpg.png')"
    >
      <div class="container">
        ...
        <a href="tournament.php" class="z-3">
          <div class="d-flex flex-row align-items-center gap-3 mt-4 z-3">
            ...
            <img
              src="tournament_thumbnail/<?php echo $results_B['thumbnail']; ?>"
          ...
          >
		    ...
		    <?php 			
				if($results_B['date_from'] < date('Y-m-d')) { 
					...
					echo "
						<div class='bg__red px-3 py-1 rounded-3 text-center z-3'>
