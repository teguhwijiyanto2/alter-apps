...
$results_2 = DB::query("
	...
	where is_withdraw_transferred<>'Y' OR is_withdraw_transferred IS NULL
												...
												<tr>
													...
													<td>
														<div class='form-button-action'>
															<a href='withdraw-confirm.php?idx=".$row_2['id']."' type='button' data-toggle='tooltip' title='Proceed withdraw' class='btn btn-link btn-primary btn-lg' data-original-title='Proceed withdraw'>
