										...
										<table id="add-row" class="display table table-striped table-hover" >
											<thead>
												<tr>
													...
													<th>Request Time</th>
													<th>Amount</th>
													<th>User's Payment Channel<br>Account No./ID<br>Account Holder Name</th>
													<th>ALTER Transfered with<br>Account No./ID<br>Account Holder Name</th>
													<th>Status</th>
													<th>Notes</th>
												</tr>
											</thead>
...
$results_2 = DB::query("
	...
	where is_withdraw_transferred='Y' AND withdraw_transfer_status='Success'
...
foreach ($results_2 as $row_2) {
	...
	echo "
												<tr>
													...
													<td>".$row_2['withdraw_id_1']."<br>".$row_2['withdraw_id_2']."<br>".$row_2['withdraw_id_3']."</td>
													<td>".$row_2['transfer_id_1']."<br>".$row_2['transfer_id_2']."<br>".$row_2['transfer_id_3']."</td>
													<td>".$row_2['withdraw_transfer_status']."</td>
													<td>".$row_2['notes']."</td>
												</tr>
	";
} // foreach ($results_2 as $row_2) {											
