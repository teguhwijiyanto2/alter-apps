...
$results_1 = DB::queryFirstRow("select * from biller_items where id=%i", $_GET['idx']);
								...
								<input type="hidden" name="idx" value="<?php echo $_GET['idx']; ?>">
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group">
												<label for="disableinput">Current ALTER Price:</label>
												<input type="text" class="form-control" disabled value="<?php echo number_format($results_1['alter_price']); ?>">
											</div>
											
											<div class="form-group">
												<label for="disableinput">Mark Up (%) :</label>
												<input type="text" name="mark_up" class="form-control" value="<?php echo $results_1['mark_up']; ?>">
											</div>	
