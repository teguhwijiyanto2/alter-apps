...
$results_2 = DB::query("
	...
	where is_withdraw_transferred='Y' AND withdraw_transfer_status='Pending'
												...
												<tr>
													...
													<td>
														<div class='form-button-action'>
															<a href='withdraw-confirm-pending.php?idx=".$row_2['id']."' type='button' data-toggle='tooltip' title='Update status' class='btn btn-link btn-primary btn-lg' data-original-title='Update status'>
