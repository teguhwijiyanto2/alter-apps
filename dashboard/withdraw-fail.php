...
$results_2 = DB::query("
	...
	where is_withdraw_transferred='Y' AND withdraw_transfer_status='Fail'
												...
												<tr>
													...
													<td>
														<div class='form-button-action'>
															<a href='withdraw-confirm-fail.php?idx=".$row_2['id']."' type='button' data-toggle='tooltip' title='Update status' class='btn btn-link btn-primary btn-lg' data-original-title='Update status'>
